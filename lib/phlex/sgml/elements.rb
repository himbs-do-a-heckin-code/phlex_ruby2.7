...
module Phlex
  class SGML
    module Elements
    	...
    	def register_element(method_name, tag: method_name.to_s.tr("_", "-"))
    					...
    					if block_given # with content block
    						...
    						begin
    							...
    							if original_length == buffer.bytesize
    								...
    								when Symbol
    									buffer << ::Phlex::Escape.html_escape(content.to_s)
    								when nil
    									nil
    								else
    	...
    	def __register_void_element__(method_name, tag: method_name.to_s.tr("_", "-"))
    		class_eval(<<~RUBY, __FILE__, __LINE__ + 1)
    			# frozen_string_literal: true
