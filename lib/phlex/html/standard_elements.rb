...
module Phlex::HTML::StandardElements
	...
	register_element def address(**attributes, &content); nil; end
	...
	register_element def article(**attributes, &content); nil; end
	...
	register_element def aside(**attributes, &content); nil; end
	...
	register_element def button(**attributes, &content); nil; end
	...
	register_element def canvas(**attributes, &content); nil; end
	...
	register_element def fencedframe(**attributes, &content); nil; end
	...
	register_element def fieldset(**attributes, &content); nil; end
	...
	register_element def figcaption(**attributes, &content); nil; end
	...
	register_element def figure(**attributes, &content); nil; end
	...
	register_element def header(**attributes, &content); nil; end
	...
	register_element def noscript(**attributes, &content); nil; end
	...
	register_element def optgroup(**attributes, &content); nil; end
	...
	register_element def option(**attributes, &content); nil; end
	...
	register_element def search(**attributes, &content); nil; end
	...
	register_element def section(**attributes, &content); nil; end
	...
	register_element def select(**attributes, &content); nil; end
	...
	register_element def template(**attributes, &content); nil; end
